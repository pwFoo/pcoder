		...
		<div id="contenedor_explorador_archivos" style="margin-left:17px;">
			...
			<div id="marco_operaciones_archivos" class="row" style="margin-top:5px; margin-bottom:10px;">
				<div class="col-md-12" align="center">
					<button OnClick="$('#myModalCREARARCHIVO').modal('show'); $('#myModalCREARARCHIVO').css('z-index', '1500');" class="btn btn-primary btn-xs" data-toggle="tooltip" data-placement="bottom" title="<?php echo $MULTILANG_PCODER_CrearArchivo; ?>"><i class="fa fa-file fa-fw"></i></button>
